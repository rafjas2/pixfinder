export function Footer() {
  ...
  return (
    <footer className="bg-brand mt-auto flex min-h-[3rem] items-center justify-center gap-6 px-6 py-4 text-sm text-white/90 shadow-[0_-4px_6px_-1px_oklch(0%_0_0_/_0.1)] sm:h-12 sm:py-0">
      <p className="text-center leading-relaxed">
        &copy; {currentYear} Designed by <strong>Rafal Jasinski</strong>.{' '}
      ...
      <a
        ...
        className="focus-visible:ring-offset-brand flex items-center gap-2 rounded p-1 transition-colors hover:text-white focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:outline-none"
      >
        <svg
        ...
        >
          <path
            d="M173.62,61.763c-91.671,0-166.675,75.004-166.675,166.677c0,70.836,44.446,131.256,106.255,155.563
